...
export const ConfirmationModal = ({
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-md bg-black/20 dark:bg-black/40 flex items-center justify-center z-50">
      <div className="bg-slate-50 dark:bg-slate-800 rounded-xl shadow-2xl max-w-md w-full mx-4 transform transition-all border border-slate-200 dark:border-slate-700">
        {/* Header */}
        ...
        <div className="px-6 py-4">
          <div className="text-sm text-slate-700 dark:text-slate-300">
            ...
            {itemName && (
              <div className="bg-slate-100 dark:bg-slate-700 rounded-md p-3 mb-3">
